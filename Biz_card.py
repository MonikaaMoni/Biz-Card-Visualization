...
# Title
st.title(':red[Business Card Data Extraction]')
    ...
    if import_image is not None:
        ...
        if session_state.data_uploaded:
            ...
            connect = mysql.connector.connect(
                  ...
                  user="root",
                  password="moni",
                  database="bizcard_db",  # Use the newly created database
                 port=3306
                )
            ...
            engine = create_engine('mysql+mysqlconnector://root:moni@127.0.0.1:3306/bizcard_db', echo=False)
    ...
    with col1:
        ...
        try:
            ...
            connect = mysql.connector.connect(
                  ...
                  user="root",
                  password="moni",
                  database="bizcrad_db",  # Use the newly created database
                 port=3306)
